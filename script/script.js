    ...
    $('#show_honor_fields').click(function(){
        if (this.checked) {
          ...
          $("#honor_name").text('someone special');
            $('.donation-container').append( '<div id="donately_form"><script  class="donately-donation-form" src="https://www.dntly.com/assets/js/v1/form.js"  async="async" type="text/javascript" data-donately-ssl="true" data-donately-id="198" data-donately-address="true" data-donately-comment="true" data-donately-phone="true"/></div>' );
        }
    });
...
$('#updateform').click(function(){
  ...
  $('#donately_form').remove();
    ...
    $(".donation-container").append( '<div id="donately_form_with_codes"><script class="donately-donation-form" src="https://www.dntly.com/assets/js/v1/form.js"  async="async" type="text/javascript" data-donately-ssl="true" data-donately-tracking-codes="' + codes + '" data-donately-id="198" data-donately-address="true" data-donately-comment="true" data-donately-phone="true"/></div>' );
